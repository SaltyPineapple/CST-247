...
namespace Registration.Controllers
{
    ...
    public class GameController : Controller
    {
        ...
        public ActionResult submitGameDetails(Board m)
        {
            ...
            {
                MyLogger.GetInstance().Info(" Exception inside submitGameDetails --> " + e.Message);
                return View("Index");
            }            
        }
        ...
        public void SaveGameState()
        {
            ...
            {
                MyLogger.GetInstance().Info(" Exception inside SaveGameState --> " + e.Message);              
            }
        }
        ...
        public void GetGameState()
        {
            ...
            {
                MyLogger.GetInstance().Info(" Exception inside GetGameState --> " + e.Message);
            }            
        }
        ...
        public ActionResult StartNewGame()
        {
            ...
            {
                MyLogger.GetInstance().Info(" Exception inside StartNewGame --> " + e.Message);
                return RedirectToAction("Index");
            }            
        }
